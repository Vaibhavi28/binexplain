...
import { extractFrontendProvenance, renderProvenanceBadge } from './utils/provenance';
                                ...
                                onClick={() => {
                                    ...
                                    om(
                                        ...
                                        <div className="result-card-body">
                                            ...
                                            {mainHints && renderProvenanceBadge(mainHints, binaryContext)}
                                            {mainHints && (
                                        ...
                                        <div className="result-card-body">
                                            {result.similar_writeups.map((w, idx) => (
                                                <div key={idx} style={{ marginBottom: '1.2rem', paddingBottom: '1rem', borderBottom: idx < result.similar_writeups.length - 1 ? '1px solid rgba(255, 255, 255, 0.1)' : 'none' }}>
                                                    ...
                                                    {renderProvenanceBadge((w.snippet || '') + ' ' + (w.key_technique || '') + ' ' + (w.title || ''), binaryContext, { hideGeneral: true })}
                                                </div>
                                            ))}
                                        </div>
                                    )}
