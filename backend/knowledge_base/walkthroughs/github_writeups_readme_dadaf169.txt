...
URL: https://raw.githubusercontent.com/ctfs/writeups/master/csaw-ctf-2014/xorcise/README.md
CHALLENGE: README
...
KEY_TECHNIQUE: ### Exploitation  We use both length-check vulnerabilities to read the secret `password`.
---
