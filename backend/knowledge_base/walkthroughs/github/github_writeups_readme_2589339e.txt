...
URL: https://raw.githubusercontent.com/ctfs/writeups/master/hitcon-ctf-2014/pushin-cat/README.md
CHALLENGE: README
...
PROTECTIONS: None
KEY_FUNCTIONS: read
KEY_TECHNIQUE: In order to exploit the server, we can make use of [all functions](http://www.h2database.com/html/functions.html) this database engine exposes.
---
